...
def upgrade() -> None:
    ...
    with op.batch_alter_table('wallet', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('bank_account_name_matching_status', sa.Enum('UNKNOWN', 'MATCHED', 'NOT_MATCHED', name='bankaccountnamematchingstatus'), server_default='UNKNOWN', nullable=False))
        batch_op.add_column(sa.Column('phone_number', sa.String(), nullable=True))
        batch_op.add_column(sa.Column('nationality', sa.String(length=2), nullable=True))
        batch_op.add_column(sa.Column('address', sa.JSON(), nullable=True))
        batch_op.add_column(sa.Column('tax_id', sa.String(), nullable=True))
        batch_op.add_column(sa.Column('financial_institution_lei', sa.String(), nullable=True))
        ...
        batch_op.add_column(sa.Column('user_type', sa.Enum('INDIVIDUAL', 'BUSINESS', name='walletusertype'), nullable=True))
        batch_op.add_column(sa.Column('fi_legal_entity_name', sa.String(), nullable=True))
        batch_op.add_column(sa.Column('ultimate_institution_country', sa.String(length=2), nullable=True))
